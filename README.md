SMC-RNA Challenge Entry: genomehacker-9610019
========================================================
...
```bash
# Clone this repo
git clone https://github.com/smc-rna-challenge/genomehacker-9610019
cd genomehacker-9610019
...
- [quay.io/smc-rna-challenge/genomehacker-9610019-gfusion:1.0.0](https://quay.io/smc-rna-challenge/genomehacker-9610019-gfusion:1.0.0)
...
Multiple, including gene name similarities
...
Inter-chromosomal, Intra-chromosomal, read-through, Self-fusion, Exon scrambling
...
nuclear mitochondrial DNA, read-through chimeras produced by co-transcription of adjacent genes
...
[data]: https://www.synapse.org/#!Synapse:syn9878905
